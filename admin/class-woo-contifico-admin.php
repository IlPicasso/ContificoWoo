 ...
 * @since 4.4.0
 */
private function resolve_location_warehouse_code( string $location_id ) {
      ...
      * @since 4.3.1
      */
     private function finalize_inventory_movement_entries( array $entries, string $status, string $reference = '', string $message = '' ) {
	 ...
	 * @since 4.3.1
	 */
          private function prepare_inventory_movement_filters( array $args ) {
	 ...
	 * @since 4.3.1
	 */
          private function sanitize_inventory_report_date( $value ) {
	 ...
	 * @since 4.3.1
	 */
          public function get_inventory_movements_report( array $args = [] ) {
...
unset( $this->preferred_warehouse_allocations[ $order_id ] );
	...
	public function contifico_call( $order_id ) {
		...
		if ( 'FAC' === $this->woo_contifico->settings['tipo_documento'] ) {
			try {
                                list( $secuencial, $documento ) = $this->generate_unique_document_number( $order, $env );
			}
			catch ( Exception $exception ) {
	 ...
	 */
         ...
         * @since 4.4.0
         */
        private function generate_order_inventory_report_pdf( WC_Order $order ) {
