...
- **Versión declarada:** 4.1.80, con autor IlPicasso y compatibilidad declarada hasta WordPress 6.8 y WooCommerce 10.3. 【F:woo-contifico.php†L9-L26】
- **Compatibilidad en el README:** Coincide con la versión 4.1.80 y refleja los mismos mínimos y versiones probadas (WP 6.8 / WC 10.3). 【F:README.txt†L1-L8】
