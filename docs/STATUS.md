...
- **Versión declarada:** 4.1.3, con autor IlPicasso y compatibilidad declarada hasta WordPress 6.5 y WooCommerce 8.7. 【F:woo-contifico.php†L9-L26】
- **Compatibilidad en el README:** Coincide con la versión 4.1.3 y refleja los mismos mínimos y versiones probadas (WP 6.5 / WC 8.7). 【F:README.txt†L1-L8】
